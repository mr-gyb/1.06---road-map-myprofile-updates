...
import { X, MessageSquare, Clock, Image, User, LayoutDashboard, Settings, LogOut, ChevronRight, ChevronDown, FileText, BarChart, Users, Network, MessageCircle, Video, Map } from 'lucide-react';
      ...
      <div className="p-4 flex-grow">
        ...
        <nav>
          <ul className="space-y-2">
            ...
            <li>
              <Link to="/road-map" className="flex items-center py-2 hover:text-gold" onClick={onClose}>
