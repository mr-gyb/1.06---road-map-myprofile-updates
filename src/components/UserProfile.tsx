...
import { MapPin, Calendar, Link as LinkIcon, Mail, Image, MessageCircle, Star, Film, ChevronLeft, X, RotateCw, Briefcase, FileText, ChevronUp, ChevronDown, Clock, HelpCircle } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="mt-20 px-4">
          ...
          <div className="flex flex-wrap gap-y-2 mt-2 text-gray-600">
            <span className="flex items-center mr-4"><MapPin size={16} className="mr-1" />{userData.location}</span>
            <span className="flex items-center mr-4"><LinkIcon size={16} className="mr-1" /><a href={userData.website} target="_blank" rel="noopener noreferrer" className="hover:underline">{userData.website}</a></span>
            <span className="flex items-center mr-4"><Calendar size={16} className="mr-1" />{userData.joinDate}</span>
          </div>
